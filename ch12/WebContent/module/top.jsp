...
%>   
     ...
     <a href="shopMain.jsp?pgm=list.jsp?book_kind=all">전체목록보기</a>&nbsp;
     <br>      
 ...
 <%}else{%>
          <a href="shopMain.jsp?pgm=list.jsp?book_kind=all">전체목록보기</a>&nbsp;
          <a href="shopMain.jsp?pgm=cartList.jsp?book_kind=all">장바구니보기</a>&nbsp;
          <a href="shopMain.jsp?pgm=buyList.jsp">구매목록보기</a>&nbsp;
      <br><br> 
